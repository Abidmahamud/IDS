...
from concurrent.futures import ThreadPoolExecutor as ABiDssb
from string import * 
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def pasw(self):       
            ...
            print(47*"-")
            with ABiDssb(max_workers=30) as ssbworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
...
def cutter():
    ...
    print(" ")
    ABiD = input('Saving Put File Name :')
    os.system('touch ' +ABiD)
    os.system('sort -r '+ssb+' | uniq > '+ABiD)
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + ssb )
    print(47*'-')
    print("File Saved To :" + ABiD )
    print(47*'-')
